          ...
          <div class="col-md-9">
            <div class="card"> 
              <div class="card-body">
                  ...
                  <?php echo form_open_multipart('pengguna/proses_edit_profil');?>
        ...
        <div class="modal-dialog tambah">
          <div class="modal-content">
            ...
            <div class="modal-body">
             <?= form_open_multipart('pengguna/proses_edit_profil/') ?>   
   ...
   <div class="modal fade" id="ganti">
        <div class="modal-dialog ganti">
          <div class="modal-content">
            ...
            <div class="modal-body">
               <form action="<?= base_url('pengguna/proses_edit_profil')?>" method="Post" id="editform2"> 
